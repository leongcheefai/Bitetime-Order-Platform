...
export function SessionProvider({ children }) {
  ...
  const [ownMerchant, setOwnMerchant] = useState(null)
  ...
  const [impersonatedMerchant, setImpersonatedMerchant] = useState(null)
  ...
  const role = isSuper ? 'superadmin' : (ownMerchant ? 'merchant' : 'customer')
  ...
  const impersonate = useCallback(async (slug) => {
  ...
  const value = { account, profile, role, merchant, ownMerchant, impersonating: !!impersonatedMerchant, impersonate, stopImpersonating, loading: account === undefined || !merchantLoaded, lang, setLang, t, refreshProfile, refreshMerchant }
