        ...
        {value.map(path => (
          <div key={path} className="relative size-16 shrink-0">
            ...
            <button
              ...
              className="absolute -top-1.5 -right-1.5 size-6 pointer-coarse:size-8 pointer-coarse:text-[15px] rounded-pill bg-primary text-white text-[12px] leading-none flex items-center justify-center shadow-sm hover:bg-brand-600 disabled:bg-disabled-bg disabled:text-disabled-fg cursor-pointer"
            >
              ×
            </button>
          </div>
