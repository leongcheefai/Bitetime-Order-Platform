      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            ...
            "z-modal-popover max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border-[1.5px] border-clay-border bg-surface-high p-1 text-ink shadow-[0_8px_24px_rgba(43,10,16,0.16)] duration-100 outline-none data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:overflow-hidden data-closed:fade-out-0 data-closed:zoom-out-95",
            className
          )}
          {...props}
        />
...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-1.5 py-1 text-xs font-medium text-rose-muted data-inset:pl-7",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        "w-auto min-w-[96px] rounded-lg border-[1.5px] border-clay-border bg-surface-high p-1 text-ink shadow-[0_8px_24px_rgba(43,10,16,0.16)] duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
        className
      )}
      align={align}
      alignOffset={alignOffset}
...
function DropdownMenuSeparator({
  ...
  return (
    <MenuPrimitive.Separator
      ...
      className={cn("-mx-1 my-1 h-px bg-clay-border", className)}
      {...props}
    />
  )
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-text-tertiary group-focus/dropdown-menu-item:text-ink",
        className
      )}
      {...props}
    />
